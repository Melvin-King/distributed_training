...
def get_device_map(n_layers, devices = range(2)):
...
class GPT2ModelCustom(GPT2Model):
    ...
    def parallelize(self, device_map=None):
        ...
        '''
        self.device_map = (
            get_device_map(n_layers = len(self.h)) if device_map is None else device_map
        )
    ...
    def forward(
        ...
        if self.pipeline_parallel:
            hidden_states = self.h_pp(hidden_states)
        else:
...
class GPT2LMHeadModelCustom(GPT2PreTrainedModel):
